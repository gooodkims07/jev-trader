...
export interface Quote { side: Side; price: number; size: number; txHash: string | null; ref?: string | null; gasMon: number; cancel: (number | string)[]; status: "sent" | "placed" | "reverted" | "lost" | "sim"; orderId: number | string | null; capped: boolean }
